...
def main():
    ...
    parser.add_argument('directory', type=str, help="The directory containing files to upload.")
    parser.add_argument('--thumbnail', type=str, help="Path to a thumbnail image.")
    parser.add_argument('--force_file', action='store_true', help="Whether to force upload files.")
    parser.add_argument('--caption', type=str, help="Caption for the uploaded files.")
